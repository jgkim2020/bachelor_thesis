...
MadgwickAHRS::MadgwickAHRS(float sampleFrequency_, float beta_)
{
	beta = beta_;
	q0 = 1.0f;
	q1 = 0.0f;
	q2 = 0.0f;
	q3 = 0.0f;
	sampleFreq = sampleFrequency_;
	invSampleFreq = 1.0f / sampleFrequency_;
}
...
Quaternionf MadgwickAHRS::getQuaternion()
{
